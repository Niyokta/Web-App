    ...
    <div className="max-w-3xl mx-auto p-6 border rounded-lg shadow-lg bg-white">
      ...
      <div className="mt-6">
        ...
        <ul className="space-y-4 mt-2">
          <li>
            <strong>Client:</strong> {project.client_name} from{" "}
          ...
          <li>
            ...
            {project.closing_price ? project.closing_price : "Not finalized"}
          </li>
          <li>
            <strong>Created At:</strong> {project.created_at.slice(0, 10)}
          </li>
          <li>
            <strong>Updated At:</strong> {project.updated_at.slice(0, 10)}
          </li>
